...
By collecting X₁₀₀₀ over many chains we approximate the same limiting
distribution as in 2a, but via an ensemble of shorter runs rather than
one long run.
...
Even when starting from state 2, the distribution of X₁₀₀₀ converges to
π, confirming ergodicity.
